##
# Customised version of the `export_all_common` function from
# `ethereumetl.jobs.export_all_common` module. More on:
#
#   https://github.com/blockchain-etl/ethereum-etl/blob/952a49ba4b53afc9b6e2c73cd42616ac1870d9c6/ethereumetl/jobs/export_all_common.py
#
#
